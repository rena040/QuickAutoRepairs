...
public class UpdatePart extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                // Parse the line using the same delimiter as in Part.fromString (colon)
                ...
                if (parts.length >= 5 && (parts[0].equalsIgnoreCase(search) || parts[1].toLowerCase().contains(search.toLowerCase()))) {
                    // Part found, display the information
                    currPrice.setText(parts[2]);
                    currStock.setText(parts[3]);
                    currSupp.setText(parts[4]);
                    
                    // Pre-populate the new fields with current values
                    newPrice.setText("");
                    newStock.setText("");
                    newSupp.setText("");
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                // Parse using colon as the delimiter
                String[] parts = line.split(":");
                
                if (parts.length >= 5 && (parts[0].equalsIgnoreCase(search) || parts[1].toLowerCase().contains(search.toLowerCase()))) {
                    // Update part line with new values
